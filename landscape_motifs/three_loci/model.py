...
def strain_matrix_4(mu):
    strain_matrix = [[(1-mu)**3, 3*mu*(1-mu)**2, (6*mu**2)*(1-mu),mu**3], 
...
def mutation_rate_transition_4(mu, tau, nbackground, noise_baseline, noise_elevated, beta = 5000):
    ...
    mutator_strain = strain_matrix_4((mu*tau)/beta)
    baseline_strain = strain_matrix_4(mu/beta)
    strain = [baseline_strain, mutator_strain]
