...
new_pM = pM_proportion(all_genotypes_aspergillus, msb_pop, all_genotypes_aspergillus[init_genotype_index][1])
...
while t < ngen:
    ...
    for rep in np.arange(nreps):
        ...
        adaptation_results[rep] = population_breaking_association(all_genotypes_aspergillus, adaptation_results[rep], wildtype)
...
output = '/home/labs/pilpel/gabril/review_NIMR/range_gamma_0_1/breaking_association_aspergillus/'
