...
new_pM = pM_proportion(all_genotypes_NK, msb_pop, all_genotypes_NK[init_genotype_index][1])
...
while t < ngen:
    ...
    for rep in np.arange(nreps):
        ...
        adaptation_results[rep] = population_limit_pM(all_genotypes_NK, adaptation_results[rep], init_genotype_index, new_pM)
...
evol_fittest = [Counter(evol_argmax[i])[NK_fittest_genotypes[NKind]] for i in range(500)]

output = '/home/labs/pilpel/gabril/review_NIMR/range_gamma_0_1/eliminating_hitchhiking_NK/'
