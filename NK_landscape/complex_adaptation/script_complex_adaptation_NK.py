...
evol_fittest = [Counter(evol_argmax[i])[NK_fittest_genotypes[NKind]] for i in range(50000)]

output = '/home/labs/pilpel/gabril/review_NIMR/range_gamma_0_1/complex_adaptation_NK/'
