...
new_pM = pM_proportion(all_genotypes_NK, msb_pop, all_genotypes_NK[init_genotype_index][1])*0.5
...
output = '/home/labs/pilpel/gabril/review_NIMR/range_gamma_0_1/limiting_pM_NK/'
