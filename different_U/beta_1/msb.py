...
def msb_simulation(genotype_names, mode, s, H, mu, tau, noise_baseline, noise_elevated, beta = 5000):
    ...
    transition_mutations = mutation_rate_transition_V(mu, tau, 5, noise_baseline, noise_elevated, beta)
